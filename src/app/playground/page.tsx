...
const Playground: React.FC = () => {
  ...
  return (
    <>
      ...
      <style>{styles}</style>
      <div className="flex flex-col min-h-screen bg-gradient-to-br from-gray-900 via-blue-950 to-gray-900 text-gray-200">
        {/* API Limit Dialog */}
        ...
        <Card className="shadow-lg border-teal-500/20 rounded-xl bg-gradient-to-br from-gray-800 to-gray-900 mx-6">
